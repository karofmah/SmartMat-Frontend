<template>
  <v-app>
    <div>
      <v-card id="menu" class="mx-auto" max-width="800">
      ...
      >
        <template v-slot:append>
          <v-btn @click="generateRecipes(numPeople)">Generate recipes</v-btn>
        </template>
      </v-slider>
...
export default {
  data() {
    return {
      cards: [
        { title: 'Monday', subtitle: 'Subtitle 1', content: 'Content for Recipe 1' },
        { title: 'Tuesday', subtitle: 'Subtitle 2', content: 'Content for Recipe 2' },
        { title: 'Wednesday', subtitle: 'Subtitle 3', content: 'Content for Recipe 3' },
        { title: 'Thursday', subtitle: 'Subtitle 4', content: 'Content for Recipe 4' },
        { title: 'Friday', subtitle: 'Subtitle 5', content: 'Content for Recipe 5' },
        { title: 'Saturday', subtitle: 'Subtitle 6', content: 'Content for Recipe 6' },
        { title: 'Sunday', subtitle: 'Subtitle 7', content: 'Content for Recipe 7' }
      ],
      numCards: 5,
      tickLabels: {
        1: 1,
